...
User: Peter Dube (Requested replacing dedicated physical POS scanning/reading modules with guest mobile devices and removing the I2C port expander to minimize deployment costs).
