"""
MADN Portable Node Server (Khumalo_Millers_Node - data-node-khumalo_millers_node-20d6cd)
...
def load_node_config() -> dict:
    if os.path.exists(CONFIG_FILE):
        with open(CONFIG_FILE, "r", encoding="utf-8") as f:
            return json.load(f)
    return {"node_id": "data-node-khumalo_millers_node-20d6cd", "node_name": "Khumalo_Millers_Node", "node_type": "data_node", "port": 8011, "is_active": True}
...
NODE_ID = cfg.get("node_id", "data-node-khumalo_millers_node-20d6cd")
