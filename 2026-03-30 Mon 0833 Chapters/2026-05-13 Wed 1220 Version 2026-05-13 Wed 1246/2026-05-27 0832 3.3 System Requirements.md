...
*   **Orchestrator Platform**: Raspberry Pi OS (64-bit Lite, Debian Bullseye/Bookworm core). The headless "Lite" version is mandatory to conserve CPU cycles and system memory, reserving maximum resources for the system services and the TensorFlow Lite inference engine.
